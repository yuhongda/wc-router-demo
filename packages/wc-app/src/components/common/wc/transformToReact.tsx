...
export function transformToReact<ElementType extends ReactBaseElement, PropsType>(TagName: any) {
  ...
  const ExportReactComponent = (RefReactComponent as unknown) as React.FC<
    PropsType & React.HTMLAttributes<ElementType>
  >;
